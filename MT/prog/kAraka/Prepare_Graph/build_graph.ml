...
value distinct_3_pUrvapaxa m1 m2 m3 = compound_pUrvapaxa_uwwarapaxa m1 m2 
                                      && distinct_2_pUrvapaxa m1 m3 
                                      && distinct_2 m2 m3
;
...
(*         -> *)
(*         (* 2.1.49 *)*)
(*         [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.1",0) ]*)
(*       | _ -> []  *)
(*       ]*)
(*  *)
(*  | _ -> *)
        ...
        if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
          if kqw_prawyaya2 = "kwa" then
            if rl_compound_kwAnwa_2 m1 then 
              ...
              (* 2.1.59 *)
              [ Relation (id1,cid1,mid1,"ka_XA",id2,cid2,mid2,"200.2",0) ]
            else if rt2 = "pawiwa" then 
              (* 2-1-24 & 2-1-38 *)
              [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.3",0); Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.2",0) ]
            else if rt2 = "Sriwa" || rt2 = "awIwa" || rt2 = "gawa" || rt2 = "awyaswa" || rt2 = "prApwa" || rt2 = "Apanna" then 
              (* 2-1-24 *)
              [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.4",0) ]
            else if rt2 = "hiwa" || rt2 = "rakRiwa" then 
              (* 2-1-36 *)
              [ Relation (id1,cid1,mid1,"wa_pu_4",id2,cid2,mid2,"200.5",0) ]
            else if rt2 = "BIwa" || rt2 = "apewa" || rt2 = "apoDa" || rt2 = "mukwa" || rt2 = "apawraswa" then 
              (* 2-1-37 vArwikam *)
              (* 2-1-38 *)
              [ Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.6",0) ]
            else if rt1 = "svayam" || rt1 = "KatvA" || rt1 = "sAmi" || member_of rt1 kAla_vAcI then 
              (* svayam kwena (2-1-25) *)
              (* KatvA kRepe (2-1-26); ninxAyAm *)
              (* sAmi (2-1-27) *)
              (* kAlAH (2-1-28) *)
              [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.7",0) ]
            else if word1 = "wawra-" then 
              (* 2-1-46 *)
              [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.8",0) ]
            else if is_swokAxi word1 then 
              (* 2-1-39 *)
              [ Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.9",0) ]
              ...
              [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.10",0) ]
            else []
            ...
            if (members_of base2 upasarga2 karaNa_verbs) || (not (verb_type base2 upasarga2 = "akarmaka")) then 
              ...
              [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.11",0) ]
            else []
          else []
        else []
       ...
       -> 
         if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
           if rt1 = "prApwa" || rt1 = "Apanna" then 
              [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.12",0) ]
           else []
         else []
     | _ -> []
     ] 
        ...
        if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
          if member_of rt1 kAla_vAcI then
            if rl_compound_yaw_2 m2 then 
              (* kqwyErqNe 2.1.43 *)
              [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
            else 
              (* awyanwasaMyoge ca 2.1.29 *)
              [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.14",0)]
          else match rt2 with 
          [ "pUrva" | "saxqSa" | "sama" | "Una" | "kalaha" | "miSra" | "SlakRNa"
            (* pUrvasaxqSasamonArWakalahanipuNamiSraSlakRNEH (2-1-31) *)
            -> [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.15",0) ]
          | "XAna" | "anna" | "oxana" | "pqWuka" 
            (* annena vyaFjanam (2-1-34) *)
	          (* BakRyeNa miSrIkaraNam (2-1-35) *)
            -> [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.16",0) ]
          | "Baya" | "BIwi" | "BI" 
            (* paFcamI Bayena 2-1-35 *)
            -> [ Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.17",0) ]
          ...
          | "xroNakAka" | "xroNa" | "bala"
            -> [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.18",0)]
          | "arWa" | "bali" | "suKa" 
            -> (* cawurWI waxarWArWabalihiwasuKarakRiwEH (2-1-36) *) 
            [ Relation (id1,cid1,mid1,"wa_pu_4",id2,cid2,mid2,"200.19",0) ]
          | "nipuNa" -> [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.14",0); Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.19",0) ]
          | _ -> 
            if member_of rt2 guNavacana then 
              (* wqwIyA wawkqwArWena guNavacanena (2-1-30) *)
              [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.20",0) ]
            else []
          ]
        else []
    | _ -> []
      ...
      -> 
        if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
          ...
          [ "yuvan" | "yuvawi" 
            ->
              if (rt2 = "Kalawi" || rt2 = "paliwa" || rt2 = "valina" || rt2 = "jarawi" || rt2 = "jaran") then
                [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.21",0) ]
              else []
          ...
          | "samAna" | "maXya" | "maXyama" | "vIra"
            -> [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.23",0) ]
          | "saw" | "mahaw" | "parama" | "uwwama" | "uwkqRta"
            -> [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.24",0) ]
          | "kawara" | "kawama" -> [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.25",0) ]
          | "kim" -> [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.26",0) ]
          | "pApa" | "aNaka" 
            -> (* Check if rt2 is a kuwsiwa word *)
              [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.27",0); Relation (id1,cid1,mid1,"ka_XA_3",id2,cid2,mid2,"200.28",0) ]
          | "kumAra" -> 
            match rt2 with 
            [ "SramaNA" | "pravrajiwA" | "kulatA" | "garBiNI" | "wApasI" 
            | "xAsI" | "banXakI" | "aXyApaka" | "aBirUpaka" | "paNdiwa" 
            | "patu" | "mqxu" | "kuSala" | "capala" | "nipuNa" 
              -> [ Relation (id1,cid1,mid1,"ka_XA",id2,cid2,mid2,"200.29",0) ]
            | _ -> []
            ]
          | _ -> match rt2 with 
                 [ "vqnxAraka" | "nAga" | "kuFjara"
                   -> (* 2-1-62 *)
                   [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.30",0) ]
                 | "garBiNI" 
                   -> if member_of rt1 cawuRpAxa_jAwi_vAcI then 
                    (* Create a file with a list of cawuRpAxa_jAwi *)
                        [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.31",0) ]
                      else []
                 ...
                 | "Srowriya" | "aXyApaka" | "XUrwa"
                   -> if member_of rt1 jAwivAcaka then 
                        (* 2-1-65 *)
                        [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.32",0) ]
                      else []
                 | "mawallikA" | "macarcikA" | "uxXa" | "prakANda" | "wallaja" 
                   -> if member_of rt1 jAwivAcaka then 
                        (* 2-1-66 *)
                        [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.33",0) ]
                      else []
                 | "KasUci" | "kiwava" 
                   -> (* 2-1-53 *)
                      [ Relation (id1,cid1,mid1,"ka_XA_2",id2,cid2,mid2,"200.34",0) ]
                 | _ -> 
                    if member_of rt1 varNa_vAcI && member_of rt2 varNa_vAcI then 
                      (* 2-1-69 *)
                      [ Relation (id1,cid1,mid1,"ka_XA_3",id2,cid2,mid2,"200.35",0) ]
                    else if (member_of rt2 jAwivAcaka) = False && 
                      (rl_compound_kqwya_1 m1 || rt1 = "wulya" || rt1 = "saxqSa") then
                      (* 2-1-68 *)
                      [ Relation (id1,cid1,mid1,"ka_XA",id2,cid2,mid2,"200.36",0) ]
                    else if member_of rt2 vyAGrAxi then 
                      (* 2-1-56 *)
                      [ Relation (id1,cid1,mid1,"ka_XA_5",id2,cid2,mid2,"200.37",0) ]
                    else if (member_of rt2 guNavacana || member_of rt2 guNa_not_guNavacana) 
                            && member_of rt1 xravyavAcI then 
                      (* 2-1-55 *)
                      [ Relation (id1,cid1,mid1,"ka_XA_4",id2,cid2,mid2,"200.38",0) ]
                      ...
                      (* if m1 is captured as kqw or wif, then it considered as kriyA *)  
                        || is_kriyA m1) then 
                      (* 2-1-57 *)
                      [ Relation (id1,cid1,mid1,"ka_XA_1",id2,cid2,mid2,"200.39",0) ] 
                    else []
                 ]
          ]
        else []
    ...
    if pUrvapaxa1 = "y" && (word1 = "a-" || word1 = "an-") then
      ...
      | WaxXiwa (id2,cid2,mid2,_,_,_,uwwarapaxa2,_,_,_,_,_) -> 
        if uwwarapaxa2 = "y" && (id1 = id2) && (cid2 > cid1) then
          (* 2-2-06 *)
          [ Relation (id1,cid1,mid1,"naF_wa_pu",id2,cid2,mid2,"200.40",0) ] 
        else []
      | _ -> []
      ]
    else []
      ...
      ->
        if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
          if rt1 = "pUrva" || rt1 = "apara" || rt1 = "aXara" || rt1 = "uwwara" then
            (* 2-2-01 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.44",0) ] 
          else if member_of rt1 xik_vAcI && member_of (word1 ^ rt2) named_entity then
            (* 2-1-50 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.45",0) ] 
          else if member_of rt1 waxXiwAnwa_xik_vAcI then
            (* 2-1-51 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.46",0) ] 
          else if member_of rt1 kAla_vAcI then
            (* 2-2-05 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.47",0) ] 
          else if rt1 = "arXa" then 
            (* 2-2-02 *)
            [ Relation (id1,cid1,mid1,"wa_pu_1",id2,cid2,mid2,"200.48",0) ] 
          else if rt1 = "xviwIya" || rt1 = "wqwIya" || rt1 = "cawurWa" || rt1 = "wurya" || rt1 = "wurIya" then 
            (* 2-2-03 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.49",0) ] 
          else if rt1 = "IRaw" && member_of rt2 guNavacana then 
            (* 2-2-07 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.50",0) ] 
          else if rt1 = "ku" || is_prAxi rt1 then 
            (* 2-2-18 *)
            [ Relation (id1,cid1,mid1,"wa_pu",id2,cid2,mid2,"200.51",0) ] 
          else if upapaxa_list rt2 then 
            (* 2-2-19 *)
            [ Relation (id1,cid1,mid1,"u_pa_wa_pu",id2,cid2,mid2,"200.52",0) ] 
          else if yAjakAxi rt2 then 
            (* 2-2-09 *)
            [ Relation (id1,cid1,mid1,"wa_pu_6",id2,cid2,mid2,"200.53",0) ] 
          else if (rt2 = "xviwIya" || rt2 = "wqwIya" || rt2 = "cawurWa" || rt2 = "wurya" || rt2 = "wurIya")
            && lifgam2 = "napuM" then 
            (* 2-2-03 *)
            [ Relation (id1,cid1,mid1,"wa_pu_6",id2,cid2,mid2,"200.54",0) ] 
          else if krIdA_jIvika rt2 then 
            (* 2-2-17 *)
            [ Relation (id1,cid1,mid1,"wa_pu_6",id2,cid2,mid2,"200.55",0) ] 
          else []
        else []
    | _ -> []
    ]
      ...
      if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then 
        if (rt1 = "Asanna" || rt1 = "axUra" || rt1 = "aXika" || member_of rt1 safKyA_vAcI) 
          && (member_of rt2 safKyA_vAcI) then
            (* 2-2-25 *)
          [ Relation (id1,cid1,mid1,"ba_vrI",id2,cid2,mid2,"200.56",0) ] 
        else if member_of rt1 xik_vAcI && member_of rt2 xik_vAcI && lifgam2 = "swrI" then 
          (* 2-2-26 *)
          [ Relation (id1,cid1,mid1,"ba_vrI",id2,cid2,mid2,"200.57",0) ] 
        else if word1 = "sa-" && not (lifgam2 = "napuM") then 
          (* 2-2-28 *)
          [ Relation (id1,cid1,mid1,"ba_vrI",id2,cid2,mid2,"200.58",0) ] 
        else []
      else []
    | _ -> []
    ]
    ...
    [ Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_) ->
      if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then 
        if member_of rt2 safKyA_vAcI then
          (* 2-2-25 *)
          [ Relation (id1,cid1,mid1,"ba_vrI",id2,cid2,mid2,"200.59",0) ] 
        else []
      else []
    | _ -> []
    ]
...
value rl_compound_D m1 m2 text_type = match m1 with 
  [ Sup (id1,cid1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
    -> match m2 with
       [ Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
         -> if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then 
              let cpd_type_x = get_assoc (rt1 ^ "_" ^ rt2) xvanxva_cpd_list in 
                if cpd_type_x = "" then []
                else [ Relation (id1,cid1,mid1,cpd_type_x,id2,cid2,mid2,"200.65",0) ]
            else []
       | _ -> []
       ]
  | _ -> []
...
(* Remove the following after checking these *)

(* aham grAma-gawam bAlakam paSyAmi *)

value rl_compound_T2 m1 m2 text_type = match m1 with
  [ Sup (id1,cid1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | WaxXiwa (id1,cid1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_) -> 
     match m2 with
     [ Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyaya2,_,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
      -> 
	  if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1)
	  then 
	    if kqw_prawyaya2 = "kwa" then
	      if rt1 = "svayam" || rt1 = "KatvA" || rt1 = "sAmi" || member_of rt1 kAla_vAcI
	        (* svayam kwena (2-1-25) *)
	        (* KatvA kRepe (2-1-26); ninxAyAm *)
	        (* sAmi (2-1-27) *)
	        (* kAlAH (2-1-28) *)
	        then [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.1",0) ]
	      else
	        match rt2 with 
	        [ "Sriwa" | "awIwa" | "pawiwa" | "gawa" | "awyaswa" | "prApwa" | "Apanna"
	          (* xviwIyA SriwAwIwapawiwagawAwyaswaprApwApannEH (2-1-24) *)
	        | "gamI" | "gAmI" | "buBukRu" | "iwya" | "nirAkariRNu" 
	          (* gamyAxInAm upasaMKyAnam (vArwikam) *)
	          -> [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.2",0) ]
	        | _ -> []
	        ]
	    else []
	  else []
     | Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
     | WaxXiwa (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_,_)  
       -> if member_of rt1 kAla_vAcI (* awyanwasaMyoge ca (2-1-29) *)
            then [ Relation (id1,cid1,mid1,"wa_pu_2",id2,cid2,mid2,"200.3",0) ]
          else []
     | _ -> []
     ]
   |_ -> []
...
value rl_compound_T3 m1 m2 text_type = match m1 with
  [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_) -> 
     match m2 with
     [ Kqw (id2,cid2,mid2,_,rt2,upasarga2,_,kqw_prawyaya2,_,_,_,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
      -> 
	  if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1)
	  then 
	    if kqw_prawyaya2 = "kwa" || kqw_prawyaya2 = "yaw" || kqw_prawyaya2 = "Nyaw"
	      (* karwqkaraNe kqwA bahulam (2.1.32 *)
	      (* kqwyEraXikArWavacane (2.1.33) *)
	      then if (members_of rt2 upasarga2 karaNa_verbs) || (not (verb_type rt2 upasarga2 = "akarmaka"))
	             then 
	               (* This check is added to ensure that T3 is not assigned if T2 or T5 are assigned *)
	               match rt2 with
	                 (* xviwIyA SriwAwIwapawiwagawAwyaswaprApwApannEH (2-1-24) *)
	               [ "Sriwa" | "awIwa" | "pawiwa" | "gawa" | "awyaswa" | "prApwa" 
	               | "Apanna" | "apewa" | "apODa" | "mukwa" | "apawraswa" 
	                 -> []
	               | _ -> 
	                 match word1 with 
	                   (* swokAnwikaxUrArWakqcCrANi kwena (2-1-39) *)
	                 [ "swokAw-" | "alpAw-" | "kRullakAw-" | "sUkRmAw-" | "SlakRNAw-" 
                         | "xaBrAw-" | "kqSAw-" | "wanu-" | "mAwrA-" | "wruti-" | "lavAw-" 
                         | "leSAw-" | "kaNAw-" | "aNu-" | "samIpAw-" | "nikatAw-" 
                         | "AsannAw-" | "sannikqRtAw-" | "sanIdAw-" | "saxeSAw-" 
                         ...
                         | "upahvarAw-" | "xUrAw-" | "viprakqRtAw-" | "parAw-" | "ArAw-" 
                         | "kqcCrAw-" | "kqcCra-" 
                           (* kwenAhorAwrAvayavAH (2-1-45) *)
                         | "pUrvAhNa-" | "aparAhNa-" | "sAyAhna-" | "maXyAhna-" 
                         | "pUrvarAwra-" | "apararAwra-"
                           (* wawra (2-1-46) *)
                         | "wawra-"
                           (* kRepe (2-1-47) *)
                         | "Basmani-" | "pravAhe-" | "uxake-"
                           (* pAwre samiwAxayaSca (2-1-48) *)
                         | "gehe-" | "garBe-"
                           -> []
                         | _ -> [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.5",0) ]
	                 ]
	               ]
	           else []
	    else []
     ...
     | Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
       -> if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1)
	    then
  	    match rt2 with 
  	    [ "pUrva" | "saxqSa" | "sama" | "Una" | "kalaha" | "nipuNa" | "miSra" | "SlakRNa"
	      (* pUrvasaxqSasamonArWakalahanipuNamiSraSlakRNEH (2-1-31) *)
	      -> [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.6",0) ]
	    | _ -> if member_of rt2 guNavacana
	             (* wqwIyA wawkqwArWena guNavacanena (2-1-30) *)
	             then [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.7",0) ]
	           else if rt2 = "XAna" || rt2 = "anna" || rt2 = "oxana" || rt2 = "pqWuka"
	             (* annena vyaFjanam (2-1-34) *)
	             (* BakRyeNa miSrIkaraNam (2-1-35) *)
 	             then [ Relation (id1,cid1,mid1,"wa_pu_3",id2,cid2,mid2,"200.8",0) ]
	           else []
	    ]
	  else []
     | _ -> []
...
value rl_compound_T4 m1 m2 text_type = match m1 with
  [ Sup (id1,cid1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | WaxXiwa (id1,cid1,mid1,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_) -> 
     match m2 with
     ...
     | Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
	  ...
	  then
            match rt2 with 
            [ "arWa" | "bali" | "hiwa" | "suKa" | "rakRiwa"
              -> (* cawurWI waxarWArWabalihiwasuKarakRiwEH (2-1-36) *) 
                [ Relation (id1,cid1,mid1,"wa_pu_4",id2,cid2,mid2,"200.9",0) ]
            | _ -> if (rt2 = "hiraNya" && rt1 = "kuNdala") || (rt2 = "xAru" && rt1 = "yUpa")
                     then [ Relation (id1,cid1,mid1,"wa_pu_4",id2,cid2,mid2,"200.10",0) ]
                   else []
            ]
          else []
     | _ -> []
...
value rl_compound_T5 m1 m2 text_type = match m1 with
  [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_) -> 
     match m2 with
     ...
     | Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
	  ...
	  then
            match rt2 with 
            [ "Baya" | "BIwi" | "BIwa" | "BI"
              (* paFcamI Bayena (2-1-37) *) 
            | "apewa" | "apODa" | "mukwa" | "pawiwa" | "apawraswa"
              (* apewApoDamukwapawiwApawraswEralpaSaH (2-1-38) *)
              ->
                [ Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.11",0) ]
            | _ -> match m2 with 
                   [ Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyaya2,_,_,_,_,_,_,_,_,_)
                     -> if kqw_prawyaya2 = "kwa"
                         then
                           match word1 with
                           [ "swokAw-" | "alpAw-" | "kRullakAw-" | "sUkRmAw-" | "SlakRNAw-" 
                           | "xaBrAw-" | "kqSAw-" | "wanu-" | "mAwrA-" | "wruti-" | "lavAw-" 
                           ...
                           | "kqcCrAw-" | "kqcCra-"
                             -> 
                             (* swokAnwikaxUrArWakqcCrANi kwena (2-1-39) *)
                             [ Relation (id1,cid1,mid1,"wa_pu_5",id2,cid2,mid2,"200.12",0)]
                           | _ -> []
                           ]
                         else []
                   | _ -> []
...
value rl_compound_T7 m1 m2 text_type = match m1 with
  [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_)
  | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_) -> 
    match m2 with
     ...
     | Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
	  ...
	  then match rt2 with
	       ...
	       [ "SONda" | "XUrwa" | "kiwava" | "vyAda" | "pravINa" 
	       | "saMvIwa" | "anwar" | "aXi" | "patu" | "paNdiwa" 
	       | "capala" | "nipuNa" | "vAsa" | "baxXa" | "aXIna" 
	       | "ata" | "brahman" | "guru"
	       (* sixXaSuRkapakvabanXESca (2-1-41) *)
	       | "sixXa" | "SuRka" | "pakva" | "banXa"
	       (* XvAfkReNa kRepe (2-1-42) *)
	       ...
	       | "xroNakAka" | "xroNa" | "bala"
	         -> [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	       (* saFjyAyAm (2-1-44) *)
	       | "wilaka" -> if word1 = "araNye-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kaseruka" -> if word1 = "vane-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "pASa" -> if rt1 = "BUmi"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "sWira" -> if word1 = "gavi-" || word1 = "yuXi-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "paSu" -> if word1 = "aByAhiwa-" || word1 = "yUWa-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "uraNa" -> if word1 = "avikate-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "wripaxikA" -> if word1 = "hale-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kArRApaNa" -> if word1 = "mukute-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kukkutikA" -> if rt1 = "naxI"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "xoha" -> if rt1 = "naxI"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "sPotaka" -> if word1 = "pUrvAhNe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "mARaka" -> if word1 = "xqRaxi-" || word1 = "araNye-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "mARAH" -> if word1 = "araNye-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kiMSuka" -> if word1 = "vane-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "bilvaka" -> if word1 = "vane-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "piSAcaka" -> if word1 = "kUpe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "harixraka" -> if word1 = "vane-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "balvajaka" -> if word1 = "vane-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "spqk" -> if word1 = "hqxi-" || word1 = "xivi-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       (* kRepe (2-1-47) *)
	       | "viRIrNa" -> if word1 = "uxake-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "mUwriwa" -> if word1 = "pravAhe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "huwa" -> if word1 = "Basmani-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       (* pAwre samiwAxayaSca (2-1-48) *)
	       | "samiwa" -> if word1 = "pAwre-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "bahula" -> if word1 = "pAwre-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "maSaka" -> if word1 = "uxumbara-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kqmi" -> if word1 = "uxara-" || word1 = "yuXi-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kacCapa" -> if word1 = "kUpa-" || word1 = "avata-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "cUrNaka" -> if word1 = "kUpa-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "maNdUka" -> if word1 = "kUpa-" || word1 = "kumBa-" || word1 = "uxapAna-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
(*	       | "kAka" -> if word1 = "nagara-"*)
(*	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]*)
(*	                     else []*)
(*	       | "vAyasa" -> if word1 = "nagara-"*)
(*	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]*)
(*	                     else []*)
	       | "puruRa" -> if word1 = "mAwari-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "SUra" -> if word1 = "piNdI-" || word1 = "piwari-" || word1 = "gehe-" || word1 = "goRTe-" 
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "narxI" -> if word1 = "gehe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "kRvedI" -> if word1 = "gehe-" || word1 = "goRTe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "vijiwI" -> if word1 = "gehe-" || word1 = "goRTe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
(*	       | "vyAda" -> if word1 = "gehe-"*)
(*	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]*)
(*	                     else []*)
	       ...
	       | "wqpwa" -> if word1 = "garBe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "baka" -> if word1 = "AKanika-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
(*	       | "patu" -> if word1 = "goRTe-"*)
(*	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]*)
(*	                     else []*)
(*	       | "paNdiwa" -> if word1 = "goRTe-"*)
(*	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]*)
(*	                     else []*)
	       | "pragalBa" -> if word1 = "goRTe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "tittiBa" -> if word1 = "karNe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "tiritirA" -> if word1 = "karNe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | "curacurA" -> if word1 = "karNe-"
	                       then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.13",0)]
	                     else []
	       | _ -> 
	         match m2 with
	         [ Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyaya2,_,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_)
	           -> if kqw_prawyaya2 = "yaw"
	                (* kqwyErqNe (2-1-43) *)
	                then [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.14",0)]
	              else if kqw_prawyaya2 = "kwa" 
	                then match rt1 with
	                     [ "pUrvAhNa" | "aparAhNa" | "sAyAhna" | "maXyAhna" 
	                     | "pUrvarAwra" | "apararAwra"
	                       (* kwenAhorAwrAvayavAH (2-1-45) *)
	                     | "wawra"
	                       (* wawra (2-1-46) *)
	                       -> [ Relation (id1,cid1,mid1,"wa_pu_7",id2,cid2,mid2,"200.15",0)]
	                     | _ -> []
	                     ]
	              else []
	         | _ -> []
     ...
     | Avy (id1,cid1,mid1,word1,rt1,pUrvapaxa1,_,_) -> 
	  ...
	  then 
	    ...
	    | "aXi" | "awi" | "xur" | "xus" | "su" | "nir" | "sa" | "upa" | "waw" | "iwi" (* avyayaM viBakwi.. (2-1-6) *)
	      -> [ Relation (id2,cid2,mid2,"A1",id1,cid1,mid1,"300.1",0) ]
	    | _ -> []
	    ]
	  else []
     | _ -> []
     ...
     [ Sup (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,lifgam2,viBakwiH2,_,_)
	  ...
	  then 
	    ...
	    [ "prawi" (* supprawinA mAwrArWe (2-1-9);prawi: mAwrArWe *)
	      -> [ Relation (id2,cid2,mid2,"A2",id1,cid1,mid1,"300.2",0) ]
	    | "pari" (* akRaSalAkAsaMKyAH pariNA (2-1-10) *)
	      -> if rt2 = "akRa" || rt2 = "SalAkA" || member_of rt2 safKyA_vAcI
	         then 
	           [ Relation (id2,cid2,mid2,"A2",id1,cid1,mid1,"300.3",0) ]
	         else []
	    | _ -> []
	    ]
	  else []
     ...
     | Avy (id2,cid2,mid2,_,rt2,_,_,_) 
	  ...
	  then 
	    ...
	    [ "muni" | "BaraxvAja" | "BAraxvAja" | "qRi" (* saMKyA vaMSyena (2-1-19) *)
	      -> [ Relation (id2,cid2,mid2,"A6",id1,cid1,mid1,"300.4",0) ]
	    | _ -> []
	    ]
	  else []
     | _ -> []
     ...
     | Avy (id2,cid2,mid2,_,rt2,_,_,_) 
	  ...
	  then 
	    ...
	    [ "pAre" | "maXye" (* pAre maXye RaRTyA vA (2-1-18) *)
	      -> [ Relation (id2,cid2,mid2,"A7",id1,cid1,mid1,"300.5",0) ]
	    | _ -> []
	    ]
	  else []
     | _ -> []
...
value rl_wa_pu_6 m1 m2 = 
  ...
  | WaxXiwa (id1,cid1,mid1,word1,_,pUrvapaxa1,uwwarapaxa1,_,_,_,_,_)
    -> match m2 with 
       ...
       | WaxXiwa (id2,cid2,mid2,word2,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_,_,_)
         -> if (id1 = id2) && (pUrvapaxa1="y") && (uwwarapaxa2="y") && (cid2 > cid1) then
              [ Relation (id1,cid1,mid1,"wa_pu_6",id2,cid2,mid2,"200.64",0) ]
            else []
       | _ -> []
       ]
  | _ -> []
...
value other_cpd_rules = [ rl_compound_D; rl_compound_kwa; rl_compound_viBakwi_wa_pu; rl_compound_K; rl_compound_xvigu; rl_compound_residual_T; rl_compound_B; rl_compound_A1; rl_compound_A2; rl_compound_A6; rl_compound_A7; ]
;
  ...
  | AvywaxXiwa (id1,cid1,mid1,word1,_,pUrvapaxa1,uwwarapaxa1,_,_)
    -> if pUrvapaxa1 = "n" then []
        ...
        rl_compound_naF m1 m2 text_type
          ...
          let rel = exceptional_cpds m1 m2 in 
          if rel = [] then 
...
(*                                 | r -> List2.union r rls*)
(*                                 ] in loop3 (List2.union relations_m1_m2_m3 acc3) r3*)
                              else if distinct_3_pUrvapaxa m1 m2 m3 then
                              let relations_m1_m2_m3 = 
                                 List.fold_left collate acc3 pUrvapaxa_rules_3 where
                                 collate rls rule = match rule m1 m2 m3 text_type with
                                 [ [] -> rls
                                 | r -> List2.union r rls
                                 ] in loop3 (List2.union relations_m1_m2_m3 acc3) r3
